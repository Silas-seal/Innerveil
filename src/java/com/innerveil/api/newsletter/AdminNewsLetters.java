    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(admin.getAutho(request)) {
            ...
            if(!(request.getParameter("title")==null)) {
                ...
                NewsLetter letter=new NewsLetter(p.getProperty("date"),p.getProperty("title"),p.getProperty("letter"));
                
                letter.submitNewsLetter();
                
            }
            
            content+="<form method=\'post\' action=\'AdminNewsLetters\'>"
                    + "<p><input type=\'text\' name=\'date\' class=\'input\' placeholder=\'Date\' /></p>"
                    + "<p><input type=\'text\' name=\'title\' class=\'input\' placeholder=\'Title\' /></p>"
                    + "<p><textarea class=\'input\' rows=\'10\' name=\'letter\' placeholder=\'Letter\'></textarea></p>"
