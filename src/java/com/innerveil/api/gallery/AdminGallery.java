 ...
 * @author Silas
 */
public class AdminGallery extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(admin.getAutho(request)) {
            ...
            if(!(request.getParameter("state")==null)) {
                ...
                gallery.submitPhotos(parts);
                
            }
            
            //Form
            content+="<form action=\'AdminGallery\' method=\'post\' enctype=\'multipart/form-data\'>"
                    + "<input type=\'hidden\' name=\'state\' value=\'upload\' />"
                    + "<p>Select images : <input type=\'file\' name=\'upload\' accept=\'image/*\' multiple /></p>"
