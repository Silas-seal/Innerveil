 ...
 * @author Silas
 */
public class AdminTestimony extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(admin.getAutho(request)) {
            ...
            //Check the forms!
            if(!(request.getParameter("testimony")==null)) {
                
                testimony.approve(request.getParameter("testimony"));
                
            }
            
            content+=testimony.getTestimoniesAdmin();
